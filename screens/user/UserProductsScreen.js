...
import { FlatList, View, Text, Button, Platform, Alert } from 'react-native';
    ...
    return (
        <FlatList data={userProducts} keyExtractor={item => item.id} renderItem={itemData => (
            <ProductItem
                ...
                onSelect={() => { editProductScreen(itemData.item.id); }}
            >
                <Button color={Colors.primary} title="Edit" onPress={() => {
                    editProductScreen(itemData.item.id);
                }} />
